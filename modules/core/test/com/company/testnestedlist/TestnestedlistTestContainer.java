package com.company.testnestedlist;
...
public class TestnestedlistTestContainer extends TestContainer {

    public TestnestedlistTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/testnestedlist/app.properties",
    ...
    public static class Common extends TestnestedlistTestContainer {

        public static final TestnestedlistTestContainer.Common INSTANCE = new TestnestedlistTestContainer.Common();
